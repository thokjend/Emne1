      ...
      <div class="flexVertical">
          <div class="flexHorizontal">
              <div class="automat">
                  ...
                  <div class="innmat">
                      ...
                      <div>
                          Mynter puttet på av kunde: ${valueFromCoinCounts(
                            coinsInserted
                          )}kr
          ...
          <div class="flexVertical">
              ...
              <div class="flexHorizontal">
                  ...
                  <button ${
                    cokesInStore <= 0 ? "disabled" : ""
                  } onclick="buyCoke()">Kjøpe cola</button>
                  <button ${
                    isCokeInDelivery == 0 ? "disabled" : ""
                  } onclick="takeCoke()">Ta cola</button>
              </div>
          </div>
      </div>
  `;
